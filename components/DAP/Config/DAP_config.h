...
#define CPU_CLOCK               400 * 1000000U   ///< Specifies the CPU Clock in Hz.
...
__STATIC_FORCEINLINE uint32_t PIN_SWCLK_TCK_IN  (void) {
  return RGPIO_ReadPinInput(GPIO_PORT_SWCLK, GPIO_PIN_SWCLK);
}
...
__STATIC_FORCEINLINE void     PIN_SWCLK_TCK_CLR (void) {
    RGPIO_ClearPinsOutput(GPIO_PORT_SWCLK, GPIO_PIN_SWCLK);
}
...
__STATIC_FORCEINLINE uint32_t PIN_SWDIO_TMS_IN  (void) {
    return RGPIO_ReadPinInput(GPIO_PORT_SWDIO, GPIO_PIN_SWDIO);
}
...
__STATIC_FORCEINLINE void     PIN_SWDIO_TMS_CLR (void) {
    RGPIO_ClearPinsOutput(GPIO_PORT_SWDIO, GPIO_PIN_SWDIO);
}
...
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT     (uint32_t bit) {
    RGPIO_WritePinOutput(GPIO_PORT_SWDIO, GPIO_PIN_SWDIO, bit & 0x1);
}
